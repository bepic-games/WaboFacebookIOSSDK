...
#ifndef WABOFACEBOOK_SWIFT_H
#define WABOFACEBOOK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WaboFacebook",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12WaboFacebook12WaboFacebook")
@interface WaboFacebook : NSObject <WaboSDKLifecycleProtocol>
+ (WaboFacebook * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// is init complete
///
/// returns:
/// is init complete
...
/// returns:
/// version
- (WaboBridgeResult * _Nonnull)bridgeVersion SWIFT_WARN_UNUSED_RESULT;
...
- (void)setWaboFacebookInitDelegate:(void (^ _Nonnull)(id _Nullable))delegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface WaboFacebook (SWIFT_EXTENSION(WaboFacebook))
- (void)getLoginParams:(void (^ _Nonnull)(id _Nullable))block;
@end
